package com.dbapp.app.ai.watcher.file.service;

import com.dbapp.utils.SystemProperUtil;
import com.dbapp.app.ai.watcher.file.FileWatcher;
...
public class FileWatchService implements DisposableBean, Runnable {
    ...
    public void run() {
        ...
        final Path path = Paths.get(SystemProperUtil.getConfPath() + SystemProperUtil.getFileSeparator());
