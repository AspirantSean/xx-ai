package com.dbapp.app.ai.utils;
...
public final class GlobalAttribute {
    ...
    public static void init() {
        ...
        try (InputStreamReader in = new InputStreamReader(new FileInputStream(com.dbapp.app.ai.utils.SystemProperUtil.getResourcesPath() + SystemProperUtil.getFileSeparator() + "global.properties"), StandardCharsets.UTF_8)) {
            //设置编码格式解决乱码
