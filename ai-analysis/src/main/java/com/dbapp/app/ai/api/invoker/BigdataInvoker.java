package com.dbapp.app.ai.api.invoker;

import com.alibaba.fastjson.JSON;
import com.dbapp.app.ai.api.exception.BigdataException;
...
public interface BigdataInvoker {
    ...
    static <T> T invoke(Supplier<com.dbapp.app.mirror.response.BigdataResponse<T>> supplier) {
